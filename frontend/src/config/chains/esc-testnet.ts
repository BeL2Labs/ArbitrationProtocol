...
const escTestnetSubgraph = hasCustomLocalSubgraphEndpoint
  ? import.meta.env.VITE_APP_LOCAL_SUBGRAPH_ENDPOINT!
  : 'https://graph.bel2.org/subgraphs/name/bel2-loan-esc-testnet';
...
export const escTestnet: ChainConfig = {
  ...
  tokens: [escTestnetBtcToken, escTestnetUSDTToken]
};
